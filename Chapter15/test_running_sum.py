...
class TestRunningSum(unittest.TestCase):
    ...
    def test_running_sum_two_items(self):
        """Test a two-items list."""
        argument = [2, 5]
        expected = [2, 7]
        sums.running_sum(argument)
        self.assertEqual(expected, argument,
                         'The list contains a two items.')


    def test_running_sum_multi_negative(self):
        """Test a negative list."""
        argument = [-1, -5, -3, -4]
        expected = [-1, -6, -9, -13]
        sums.running_sum(argument)
        self.assertEqual(expected, argument,
                         'The list contains a negative values.')
    ...
    def test_running_sum_multi_mix(self):
        """Test a list containing mixture of negative values,
        zeros and positive values."""
        argument = [4, 0, 2, -5, 0]
        expected = [4, 4, 6, 1, 1]
        sums.running_sum(argument)
        self.assertEqual(expected, argument,
                         'The list contains mixture of values.')
